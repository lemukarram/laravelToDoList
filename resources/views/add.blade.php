        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5 custom_height">
                ...
                <input type="hidden" name="tz" id="tz">
                    ...
                    <div class="form-group">
                        <input type="text" id="datetimepicker" name="deadline" class="bg-gray-100 rounded border border-gray-400 leading-normal resize-none w-full placeholder-gray-700 focus:outline-none focus:bg-white "  placeholder='Select Deadline' />  
